...
sys.path.insert(0, '/home/baker/Work/Codes/Python/segmentation')
import torch
...
train_image_dir = '/media/baker/C05A8B528B5B5A2D/data/ZhangBC/EM/Level_2/V1/train/image'
train_mask_dir = '/media/baker/C05A8B528B5B5A2D/data/ZhangBC/EM/Level_2/V1/train/label'

val_image_dir = '/media/baker/C05A8B528B5B5A2D/data/ZhangBC/EM/Level_2/V1/validation/image'
val_mask_dir = '/media/baker/C05A8B528B5B5A2D/data/ZhangBC/EM/Level_2/V1/validation/label'

test_image_dir = '/media/baker/C05A8B528B5B5A2D/data/ZhangBC/EM/Level_2/V1/test/image'
test_mask_dir = '/media/baker/C05A8B528B5B5A2D/data/ZhangBC/EM/Level_2/V1/test/label'
